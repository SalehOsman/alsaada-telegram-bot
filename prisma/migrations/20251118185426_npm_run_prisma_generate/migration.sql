...
INSERT INTO "new_INV_Category" ("code", "createdAt", "createdBy", "description", "icon", "id", "isActive", "nameAr", "nameEn", "orderIndex", "prefix", "updatedAt", "updatedBy") SELECT "code", "createdAt", "createdBy", "description", "icon", "id", "isActive", "nameAr", "nameEn", "orderIndex", "prefix", "updatedAt", "updatedBy" FROM "INV_Category";
...
CREATE TABLE "new_INV_Item" (
    ...
    "quantityImport" REAL NOT NULL DEFAULT 0,
    "supplierName" TEXT,
...
INSERT INTO "new_INV_Item" ("barcode", "categoryId", "code", "createdAt", "createdBy", "description", "documents", "id", "imagePath", "images", "isActive", "locationId", "manufacturer", "minQuantity", "nameAr", "nameEn", "notes", "partNumber", "quantity", "responsibleEmployeeId", "specifications", "supplierContact", "supplierName", "totalValue", "unit", "unitCapacity", "unitPrice", "updatedAt", "updatedBy") SELECT "barcode", "categoryId", "code", "createdAt", "createdBy", "description", "documents", "id", "imagePath", "images", "isActive", "locationId", "manufacturer", "minQuantity", "nameAr", "nameEn", "notes", "partNumber", "quantity", "responsibleEmployeeId", "specifications", "supplierContact", "supplierName", "totalValue", "unit", "unitCapacity", "unitPrice", "updatedAt", "updatedBy" FROM "INV_Item";
DROP TABLE "INV_Item";
