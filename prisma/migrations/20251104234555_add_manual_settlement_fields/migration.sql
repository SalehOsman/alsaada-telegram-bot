...
INSERT INTO "new_HR_Transaction" ("amount", "approvedAt", "approvedBy", "createdAt", "createdBy", "description", "employeeId", "id", "isSettled", "itemId", "notes", "payrollCycleId", "quantity", "rejectionReason", "settledAt", "settledBy", "status", "transactionNumber", "transactionType", "unitPrice", "updatedAt", "updatedBy") SELECT "amount", "approvedAt", "approvedBy", "createdAt", "createdBy", "description", "employeeId", "id", "isSettled", "itemId", "notes", "payrollCycleId", "quantity", "rejectionReason", "settledAt", "settledBy", "status", "transactionNumber", "transactionType", "unitPrice", "updatedAt", "updatedBy" FROM "HR_Transaction";
